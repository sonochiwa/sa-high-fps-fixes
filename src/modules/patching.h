...
extern std::array<SitePatch, 3> g_continuousShotPatches;
...
extern std::array<SitePatch, 2> g_pickUpAlignPatches;
...
extern SitePatch g_movingPartStepPatch;
...
extern SitePatch g_radioFrameLockPatch;
